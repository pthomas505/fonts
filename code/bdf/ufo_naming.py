# Copied from https://unifiedfontobject.org/versions/ufo3/conventions/#example-implementation
# Added missing NameTranslationError class and removed no longer supported and no longer needed check for Unicode strings.
